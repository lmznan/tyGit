...
$(function () {
  /* 获取页面元素 */
  //手机
  var $tel = $('.reg-tel input'); //验证码生成

  var $getCode = $('.ven-code'); //验证码输入

  var $code = $('.reg-code input'); //短信验证码 输入

  var $msg = $('.txt-msg'); //短信验证码获取按钮

  var $getmsg = $('.get-msg'); //密码

  var $pwd = $('.reg-pwd dd input'); //确认密码

  var $subPwd = $('.reg-subPwd dd input'); //提交按钮

  var $form = $('form');
  /* 获取错误提示框 */

  var $ts1 = $('.reg-tel dd span');
  var $ts2 = $('.msg-ts');
  var $ts3 = $('.reg-pwd dd span');
  var $ts4 = $('.reg-subPwd dd span');
  /* 设置正则表达式 */
  //tel正则

  var re1 = /^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$/; //密码
  ...
  $form.submit(function () {
    var arr = [false, false, false, false, false]; //验证手机号
          ...
          if ($code.val() !== $getCode.html()) {
            ...
            if ($tel.val() in $cookieObj) {
              ...
              var time = setInterval(function () {
                $getmsg.val("".concat(--second, "\u79D2\u540E\u53EF\u91CD\u65B0\u83B7\u53D6"));
              }, 1000);
              setTimeout(function () {
